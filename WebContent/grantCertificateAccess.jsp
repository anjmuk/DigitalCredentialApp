...
<body bgcolor="#FADBD8">
<a href="learnerHome?userId=${learnerDetails.userId}">Learner Home</a>
	<div align="center">
		<%@page import="java.util.ArrayList"%>
		<%--Importing all the dependent classes--%>
		<%@page import="com.digitalcredentials.vo.SearchLearnerRecordsVO"%>

		<h1 align="center" style="color: blue;">Grant Certificate Access to an Organization</h1>
		<form:form method="POST" action="createCertificateAccess"
			...
			<table>
				...
				<tr>
					...
					<td><form:input path="organizationEIN" size="9" required="required"
