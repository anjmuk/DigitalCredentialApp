...
<a href="/DigitalCredential">Home</a>
	<div align="center">
		<h1 align="center" style="color: blue;">Organization SignUp</h1>
		<form:form method="POST" action="organizationSignUp" modelAttribute="signUpDetails">
			<table>
				<tr>
					<td>Organization Name:</td>
					<td><form:input path="name" size="30" required="required"
							maxlength="30" minlength="8" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td>Password:</td>
					<td><form:input path="password" type="password" size="20"
							required="required" maxlength="20" minlength="8" /></td>
				</tr>
