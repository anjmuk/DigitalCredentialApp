...
<a href="universityHome?userId=${userDetails.userId}">University
	...
	<div align="center">
		...
		<h1 align="center" style="color: blue;">Add Course Completion</h1>
		<form:form method="POST" action="addCourse"
			...
			<table>
				...
				<tr>
					<td>Select Course:</td>
					<td><form:select path="course" required="required"
							items="${courseList}" /></td>
				</tr>
				<tr>
...
<tr>
					...
					<td><form:input path="endDate" size="8" required="required"
							type="number" maxlength="8" minlength="8" /></td>
				</tr>
				<tr>
					<td>Select Grade:</td>
					<td><form:select path="courseGrade" required="required"
							items="${gradeList}" /></td>
				</tr>
				<tr>
