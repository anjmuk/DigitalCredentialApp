...
<a href="learnerHome?userId=${learnerDetails.userId}">Learner
	...
	<div align="center">
		...
		<h1 align="center" style="color: blue;">Search Learner Course</h1>
		<form:form method="POST" action="findLearnerCourse"
			...
			<table>
				...
				<tr>
					<td>EIN:</td>
					<td><form:input path="universityEIN" size="9" required="required"
				...
				<tr>
					<td>Select Career:</td>
					<td><form:select path="career" items="${careerList}"  required="required"/></td>
				</tr>
				<tr>
					<td>Select Subject:</td>
					<td><form:select path="subject" items="${subjectList}"  required="required"/></td>
				</tr>
				<tr>
					<td>Select Concentration:</td>
					<td><form:select path="concentration"
							items="${concentrationList}"  required="required"/></td>
				</tr>
